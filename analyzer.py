...
def main():
    ...
    不要出現沒必要的重複翻譯中文的英文。
    不要給標題。
    摘要中不要有表格，如果要放表格，請轉成文字描述。
    請在文章的第一句話寫"大家好，以下為12小時內{market_name}新聞重點摘要"
    ...
    報告段落如下，不要新增或減少段落：
    1.  **摘要與核心觀點**
    2.  **市場概覽**：總結這段時間內{market_name}市場的整體氣氛和主要指數的表現。
    3.  **焦點板塊與題材**：哪些產業或概念股是這段時間的{market_name}市場焦點？為什麼？
    4.  **關鍵公司動態**：提及至少三家在這批新聞中最重要的{market_name}公司，並說明它們發生了什麼關鍵事件（如財報、法說會、重大消息等）。
    5.  **分析與展望**：綜合所有資訊，提出你對短期{market_name}市場走勢的專業見解或潛在的觀察重點。
